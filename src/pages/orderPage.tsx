...
import { ArrowDropDown, CheckBoxOutlineBlank, GetApp } from '@mui/icons-material';
...
const OverviewTab = () => (
    <><Box className="p-6 bg-white max-w-[550px] mx-auto rounded-md shadow-md mb-10">
        ...
        <div className="details" style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <hr style={{ margin: '20px' }} />
            <p style={{ marginBottom: '15px' }}>Patrick Francis</p>
            <p style={{ marginBottom: '15px' }}>francisdaniel140@gmail.com</p>
            <p style={{ marginBottom: '15px' }}>+23408092363468</p>
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
    ...
    <Table.Header>
      <Table.Row>
        ...
        <Table.RowHeaderCell>
          ...
          <Button variant="solid" startIcon={<GetApp />}>
            Export
          </Button>
        </Table.RowHeaderCell>
        <Table.RowHeaderCell>
          {/* Dropdown icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="more vertical" class="sc-gLDzan iqLDnp" style={{ width: '24px', height: '24px' }}>
        ...
        <Table.Body>
          ...
          {Array.from({ length: 10 }).map((_, index) => (
            <Table.Row key={index}>
              ...
              <Table.Cell>Customer Name {index + 1}</Table.Cell>
              <Table.Cell>$200</Table.Cell>
              <Table.Cell >Feb 7, 2024</Table.Cell>
            </Table.Row>
          ))}
        </Table.Body>
      </Table.Root>
  ...
  return (
    <AppLayout>
      <Box style={{ backgroundColor: 'var(--gray-a2)', borderRadius: 'var(--radius-3)' }}>
          ...
          <Flex gap={4} style={{backgroundColor:"#000"}}>
