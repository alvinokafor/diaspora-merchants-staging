...
import { Button, Flex, Tabs, Badge, TextField } from "@radix-ui/themes";
        ...
        {data &&
          data.map((store: StoreDetail) => (
            <Table.Row key={store.id}>
              ...
              <Table.Cell>
                <Button style={{ backgroundColor: "#EAECF0", color: "#000" }}>
                  Cancel Order
                </Button>
              </Table.Cell>
              <Table.Cell>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <FiSearch
                style={{ marginRight: 2, marginLeft: 5, color: "#000" }}
              />
